...
export async function generateMetadata({
  ...
  return {
    ...
    description: catInfo.config.seoIntro || `Shop ${items.length} ${catInfo.config.name.toLowerCase()} at Always Lit Cannabis.`,
  };
}
      ...
      <section className={styles.seoSection}>
        <div className={styles.container}>
          ...
          <div className={styles.visitCta}>
            <h3 className={styles.visitTitle}>Visit Always Lit Cannabis</h3>
            <p className={styles.visitText}>
              644 Queen St W, Toronto, ON M6J 1E4 · Open daily 10 AM – 3 AM
            </p>
            <a
